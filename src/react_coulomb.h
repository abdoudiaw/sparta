...
#ifndef SPARTA_REACT_COULOMB_H
#define SPARTA_REACT_COULOMB_H
...
class ReactCoulomb : public React {
 public:
  ReactCoulomb(class SPARTA *, int, char **);
  ReactCoulomb(class SPARTA *);
  virtual ~ReactCoulomb();
  virtual void init();
